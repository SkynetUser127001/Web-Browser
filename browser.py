...
class AboutDialog(QDialog):
    def __init__(self, *args, **kwargs):
        ...
        layout.addWidget(QLabel("Copyright 2020 Goon by Neil Goswami"))
...
class MainWindow(QMainWindow):
    def __init__(self, *args, **kwargs):
        ...
        about_action = QAction(QIcon(os.path.join('images', 'question.png')), "About Goon Browser", self)
        about_action.setStatusTip("Find out more about Goon Browser")  # Hungry!
        about_action.triggered.connect(self.about)
        help_menu.addAction(about_action)

        navigate_mozarella_action = QAction(QIcon(os.path.join('images', 'lifebuoy.png')),
                                            "Goon Browser Homepage", self)
        navigate_mozarella_action.setStatusTip("Go to Goon Browser Homepage")
        navigate_mozarella_action.triggered.connect(self.navigate_mozarella)
        help_menu.addAction(navigate_mozarella_action)

        self.add_new_tab(QUrl('http://www.welcometointernet.org'), 'Homepage')

        self.show()

        self.setWindowTitle("Goon")
    ...
    def update_title(self, browser):
        ...
        self.setWindowTitle("%s - Goon " % title)
    ...
    def navigate_home(self):
        self.tabs.currentWidget().setUrl(QUrl("http://www.welcometointernet.org"))
...
app.setOrganizationName("Goon by Neil Goswami")
